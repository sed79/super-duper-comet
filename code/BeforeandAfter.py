...
def plot_beforeafter_hist():
    ...
    plt.savefig('../output_images/BeforeAfter_hist_captions.pdf')
...
def plot_beforeafter():
    ...
    plt.savefig('../output_images/BeforeAfter_captions.pdf')
...
def plot_beforeafter_image_and_hist():
    ...
    plt.savefig('../output_images/BeforeAfter_fourimages.pdf')
    return
