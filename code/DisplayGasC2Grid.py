...
directory =  '../data/MedianCoaddedMaps/C2_ALL/' #400x400 C2 maps
...
def plot():
    ...
    for ax, date in zip(axes,dates):
        hdulist = fits.open(directory+'C2_'+date+'.fits',ignore_missing_end=True)
    ...
    plt.savefig('../output_images/GasC2Grid_diff.pdf')
