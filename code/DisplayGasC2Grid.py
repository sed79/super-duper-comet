...
directory =  '../data/CroppedMaps/C2_ALL/' #240x240 C2 maps
...
def plot():
    ...
    for ax, date in zip(axes,dates):
        hdulist = fits.open(directory+'Cropped_C2_'+date+'.fits',ignore_missing_end=True)
        if date == '2019-11-14':
    ...
    plt.savefig('../output_images/GasC2Grid.pdf')
